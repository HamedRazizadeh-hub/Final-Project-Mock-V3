  ...
  return (
    <div className="sheet">
      <div className="sheet-head">
        <div>
          <p style={{ fontFamily: 'var(--font-display)', fontSize: 30, fontWeight: 500, letterSpacing: '-0.015em' }}>
            {resume.name}
          </p>
          ...
          <div className="stack" style={{ gap: 16 }}>
            {resume.experiences.map((entry) => (
              <div key={entry.id}>
                ...
                {entry.description ? (
                  <p style={{ marginTop: 5, fontSize: 13, lineHeight: 1.55, color: 'var(--ink-3)' }}>
                    {entry.description}
                  </p>
                ) : null}
              </div>
        ...
        <div className="sheet-block">
          ...
          <div className="stack" style={{ gap: 10 }}>
            {resume.education.map((entry) => (
              <p className="sheet-entry" key={entry.id}>
