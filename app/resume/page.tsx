...
import { type ResumeEducation, type ResumeExperience, useApp } from '@/lib/store';
    ...
    <div className="wrap">
      <div className="resume-head">
        <div>
          ...
          <h1 className="display" style={{ fontSize: 'clamp(30px, 3.8vw, 46px)' }}>
            Resume Builder
          </h1>
        </div>
        <div className="row" style={{ gap: 8 }}>
          ...
          <button
            ...
            onClick={() => {
              toast('Opening print view — PDF export is optional');
              window.print();
            }}
          >
            Export PDF
      ...
      <div className="resume-layout">
        <div className="editor" data-tab={tab}>
          <section>
            <p className="label label-ink" style={{ marginBottom: 14 }}>
              Personal details
            </p>
            <div className="field-grid">
              <label className="field">
                ...
                <input
                  className="input"
                  value={resume.name}
                  onChange={(event) => patchResume({ name: event.target.value })}
                  style={{ height: 40 }}
                />
              </label>
              <label className="field">
                ...
                <input
                  className="input"
                  value={resume.email}
                  onChange={(event) => patchResume({ email: event.target.value })}
                  style={{ height: 40 }}
                />
              </label>
              <label className="field">
                ...
                <input
                  className="input"
                  value={resume.phone}
                  onChange={(event) => patchResume({ phone: event.target.value })}
                  style={{ height: 40 }}
                />
              </label>
              <label className="field">
                ...
                <input
                  className="input"
                  value={resume.city}
                  onChange={(event) => patchResume({ city: event.target.value })}
                  style={{ height: 40 }}
                />
              </label>
            </div>
          ...
          <section>
            ...
            <input
              className="input"
              value={resume.role}
              onChange={(event) => patchResume({ role: event.target.value })}
              style={{ height: 40 }}
            />
          </section>
          ...
          <section>
            <p className="label label-ink" style={{ marginBottom: 12 }}>
              Skills
            </p>
            <p className="small" style={{ marginBottom: 12 }}>
              Pulled from your Match Profile — click to include or exclude.
            </p>
            <div className="chips">
              {profile.skills.map((skill) => {
                ...
                return (
                  <button
                    ...
                    onClick={() =>
                      patchResume({
                        skills: on ? resume.skills.filter((item) => item !== skill) : [...resume.skills, skill],
                      })
                    }
                  >
                    {skill}
              ...
              <button
                ...
                onClick={() =>
                  patchResume({
                    experiences: [
                      ...resume.experiences,
                      { id: newId('exp'), role: '', company: '', dates: '', description: '' },
                    ],
                  })
                }
              >
                ...
                <div className="entry" key={entry.id}>
                  <div className="field-grid">
                    ...
                    <input
                      ...
                      value={entry.dates}
                      onChange={(event) => patchExperience(index, { dates: event.target.value })}
                      style={{ height: 38 }}
                    />
                  </div>
                  <textarea
                    ...
                    onChange={(event) => patchExperience(index, { description: event.target.value })}
                  />
                  <button
                    type="button"
          ...
          <section>
            <div className="spread" style={{ alignItems: 'baseline', marginBottom: 14 }}>
              ...
              <button
                ...
                onClick={() =>
                  patchResume({
                    education: [...resume.education, { id: newId('edu'), program: '', school: '', dates: '' }],
                  })
                }
              >
                + Add education
                ...
                <div className="entry" key={entry.id}>
                  <div className="field-grid">
                    <input
                      ...
                      value={entry.program}
                      onChange={(event) => patchEducation(index, { program: event.target.value })}
                      style={{ height: 38 }}
                    />
                    <input
                      className="input"
                    ...
                    <input
                      ...
                      value={entry.dates}
                      onChange={(event) => patchEducation(index, { dates: event.target.value })}
                      style={{ height: 38 }}
                    />
                  </div>
                  <button
